...
const EnhancedTestDriveDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`/api/testDrive/get/${id}`, {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchCarData = async (carId) => {
      ...
      const url = `/api/cars/cars/${carIdString}`;
  ...
  const handleCancel = async () => {
    try {
      const response = await fetch(`/api/testDrive/${id}/cancel`, {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
  ...
  const confirmDelete =async () => {
    try {
      const response = await fetch(`/api/testDrive/delete/${id}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
...
export default EnhancedTestDriveDetails;
